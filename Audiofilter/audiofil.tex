...
\label{input_audio}
\item The input sound file used for the code is taken from the below link
\begin{lstlisting}
$https://github.com/krishnakaustubh11005/EE1205/tree/main/Audiofilter/codes/kkaudio_2.wav

\end{lstlisting}
\item 
\label{Python code}
A Python Code is written to achieve Audio Filtering 
\lstinputlisting{./codes/audiofilter2.py}\label{prob:audio_filter_problem}
...
\begin{lstlisting}
https://github.com/krishnakaustubh11005/EE1205/tree/main/Audiofilter/codes/2.2.c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/krishnakaustubh11005/EE1205/tree/main/Audiofilter/codes/2.2.py
\end{lstlisting}
\begin{figure}[H]
	\centring
...
\begin{lstlisting}
https://github.com/krishnakaustubh11005/EE1205/tree/main/Audiofilter/codes/3.5.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/krishnakaustubh11005/EE1205/tree/main/Audiofilter/codes/4.2.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
%
\begin{lstlisting}
https://github.com/krishnakaustubh11005/EE1205/tree/main/AudioFilter/codes/4.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/krishnakaustubh11005/EE1205/tree/main/Audiofilter/codes/5_sol.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/krishnakaustubh11005/EE1205/tree/main/Audiofilter/codes/5.4.py   
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/krishnakaustubh11005/EE1205/tree/main/Audiofilter/codes/5.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/krishnakaustubh11005/EE1205/tree/main/Audiofilter/codes/6.1.py 
\end{lstlisting}
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{figs/output_verf.png}
...
\begin{align}
	&y(n) - \brak{3.65}y(n - 1) + \brak{5.03}y(n - 2) \nonumber \\
	&- \brak{3.083}y(n - 3) + \brak{0.710}y(n - 4) \nonumber \\
	&= \brak{1.55\times 10^{-5}}x(n) + \brak{6.22 \times 10^{-5}}x(n - 1) \nonumber \\
	&+ \brak{9.33 \times 10^{-5}}x(n - 2) + \brak{6.22 \times 10^{-5}}x(n - 3) \nonumber \\
	&+ \brak{1.55 \times 10^{-5}}x(n - 4)
\end{align}
...
\begin{lstlisting}
https://github.com/krishnakaustubh11005/EE1205/tree/main/Audiofilter/codes/6.2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/krishnakaustubh11005/EE1205/tree/main/Audiofilter/codes/6_filter_response.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\end{align}
\begin{lstlisting}
https://github.com/krishnakaustubh11005/EE1205/tree/main/Audiofilter/codes/analog_filt.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/krishnakaustubh11005/EE1205/tree/main/Audiofilter/codes/6.2_pole-zero.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/krishnakaustubh11005/EE1205/tree/main/Audiofilter/codes/fft.c
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/krishnakaustubh11005/EE1205/tree/main/Audiofilter/codes/fft_python.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/krishnakaustubh11005/EE1205/tree/main/Audiofilter/codes/6.4_time.c
\end{lstlisting}
The below python code extracts the data from these text files and plots Time vs $n$ for comparison.
\begin{lstlisting}
https://github.com/krishnakaustubh11005/EE1205/tree/main/Audiofilter/codes/6.4_plot.py
\end{lstlisting}
\begin{figure}[H]
\centering
\includegraphics[width=1\columnwidth]{figs/Time Complexity Comparison.png}
...
\solution
A better filtering was found on setting the order of the filter to be 6.
